	...
	<div class="m-right">
		<div class="main">
			...
			<s:form action="add" namespace="/manageBean" method="post"
				...
				<s:textfield name="bv.beanname" label="咖啡豆名"></s:textfield>
				<s:textfield name="bv.producthome" label="产地"></s:textfield>
				<s:textfield name="bv.greenprice" label="生豆价格"></s:textfield>
				<s:textfield name="bv.cookedprice" label="熟豆价格"></s:textfield>
