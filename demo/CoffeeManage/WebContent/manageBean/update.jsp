	...
	<div class="m-right">
		<div class="main">
			...
			<s:form action="update" namespace="/manageBean" method="post"
				...
				<s:textfield name="bv.beanname" label="咖啡豆名" value="%{bv.beanname }"></s:textfield>
				<s:textfield name="bv.producthome" label="产地"
					value="%{bv.producthome }"></s:textfield>
				<s:textfield name="bv.greenprice" label="生豆价格"
					value="%{bv.greenprice }"></s:textfield>
				<s:textfield name="bv.cookedprice" label="熟豆价格"
